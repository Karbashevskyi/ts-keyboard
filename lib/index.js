...
function keyboard($event, configuration) {
    ...
    if (($event === null || $event === void 0 ? void 0 : $event.metaKey) || $event.ctrlKey) {
        ...
        if (configuration === null || configuration === void 0 ? void 0 : configuration.allow) {
            Object.keys(configuration === null || configuration === void 0 ? void 0 : configuration.allow).forEach((keyName) => {
                var _a, _b, _c, _d, _e, _f;
                const allow = configuration === null || configuration === void 0 ? void 0 : configuration.allow;
                if (allow === null || allow === void 0 ? void 0 : allow[keyName]) {
                    if ((_a = ts_keycode_1.keycodeSegments === null || ts_keycode_1.keycodeSegments === void 0 ? void 0 : ts_keycode_1.keycodeSegments[keyName]) === null || _a === void 0 ? void 0 : _a.hasOwnProperty(index_enum_1.KeycodeEnum[key])) {
                        if (($event === null || $event === void 0 ? void 0 : $event.shiftKey) || $event.getModifierState('CapsLock')) {
                            if (((_b = allow === null || allow === void 0 ? void 0 : allow.shift) !== null && _b !== void 0 ? _b : true) ||
                                ((_d = (_c = allow === null || allow === void 0 ? void 0 : allow[keyName]) === null || _c === void 0 ? void 0 : _c.shift) !== null && _d !== void 0 ? _d : true)) {
                                if ((_f = (_e = allow === null || allow === void 0 ? void 0 : allow[keyName]) === null || _e === void 0 ? void 0 : _e.shift) !== null && _f !== void 0 ? _f : true) {
                                    notAllowed = false;
                                }
                            }
                        }
